...
class TestDashboardAPI(unittest.TestCase):
    ...
    def tearDownClass(cls) -> None:
        ...
        test_dashboard_id = cls.api.get_dashboard_id('Incident_Management')
    ...
    def test_get_dashboard(self):
        ...
        self.assertEqual(dashboard.get('title'), 'Incident_Management')

        with self.assertRaises(Exception):
            _ = self.api.get_dashboard('never-ever-matches-a-dashboard')

    def test_get_dashboard_id(self):
        test_dashboard_id = self.api.get_dashboard_id('Incident_Management')
    ...
    def test_share_dashboard(self):
        id_ = self.api.get_dashboard_id('Incident_Management')

        actual = self.api.share_dashboard(id_,[self.api.user.user_id]).json()
